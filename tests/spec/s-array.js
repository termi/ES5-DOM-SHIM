describe('Array', function() {
	...
	describe('find', function() {
        "use strict";
        var actual, expected, testSubject, index;
        ...
        it('should find the element', function() {
            expected = 'hej';
            actual = testSubject.find(function(item){ return item === expected });
            expect(actual).toEqual(expected);
        });
        it('should not find the element', function() {
            expected = void 0;
            actual = testSubject.find(function(item){ return item === -1 });
            expect(actual).toEqual(expected);
        });
        it('should find undefined as well', function() {
            expected = void 0;
        ...
        it('should skip unset indexes', function() {
            expected = void 0;
            actual = testSubject.find(function(item, ind){ return item === expected ? ((index = ind), true) : false });
            expect(actual).toEqual(expected);
        ...
        describe('Array-like', function ArrayLike() {
			...
			it('should find the element (array-like)', function() {
				expected = 'hej';
				actual = find.call(testAL, function(item){ return item === expected });
				expect(actual).toEqual(expected);
			});
			it('should not find the element (array-like)', function() {
				expected = void 0;
				actual = find.call(testAL, function(item){ return item === -1 });
				expect(actual).toEqual(expected);
			});
			it('should find undefined as well (array-like)', function() {
				expected = void 0;
			...
			it('should skip unset indexes (array-like)', function() {
				expected = void 0;
				actual = find.call(testAL, function(item, ind){ return item === expected ? ((index = ind), true) : false });
				expect(actual).toEqual(expected);
				expect(index).toEqual(2);
			});
        });
	...
	describe('findIndex', function() {
        ...
        it('should find the element', function() {
            expected = 4;
            actual = testSubject.findIndex(function(item){ return item === 'hej' });
            expect(actual).toEqual(expected);
        });
        it('should not find the element', function() {
            expected = -1;
            actual = testSubject.findIndex(function(item){ return item === -1 });
            expect(actual).toEqual(expected);
        });
        it('should find undefined as well and should skip unset indexes', function() {
            expected = 2;
            actual = testSubject.findIndex(function(item){ return item === void 0 });
            expect(actual).toEqual(expected);
        });
        ...
        describe('Array-like', function ArrayLike() {
			...
			it('should find the element (array-like)', function() {
				expected = 4;
				actual = findIndex.call(testAL, function(item){ return item === 'hej' });
				expect(actual).toEqual(expected);
			});
			it('should not find the element (array-like)', function() {
				expected = -1;
				actual = findIndex.call(testAL, function(item){ return item === -1 });
				expect(actual).toEqual(expected);
			});
			it('should find undefined as well (array-like)', function() {
				expected = 2;
				actual = findIndex.call(testAL, function(item){ return item === void 0 });
				expect(actual).toEqual(expected);
			});
        });
    });
    ...
    describe("Array.of", function() {
        it("returns Array: type of Array.of(0, 1) is '[object Array]'", function()
		{
			expect(Object.prototype.toString.call(Array.of(0, 1))).toEqual('[object Array]');
		})

		it("converting a variable number of argument to array: 'Array.of(0, 1) are equal [0, 1]'", function()
		{
			expect(Array.of(0, 1)).toEqual([0, 1]);
		})
    });

    describe("Array.from", function() {
        it("returns Array: type of Array.from('01') is '[object Array]'", function()
		{
			expect(Object.prototype.toString.call(Array.from('01'))).toBe('[object Array]');
		})

		it("converting a string to array: Array.from('01') is '[0, 1]'", function()
		{
			expect(Array.from('01')).toEqual(['0', '1']);
		})

		it('array from arguments: Array.from(arguments) converted to [0, 1]', function()
		{
			expect(function(){return Array.from(arguments);}(0, 1)).toEqual([0, 1]);
		})

		it('[ callback [ value ] ]', function()
		{
			expect(Array.from('12', function(value) {return value;})).toEqual(['1','2']);
		})

		it('[ callback [ index ] ]', function()
		{
			expect(Array.from('12', function(value, index) {return index;})).toEqual([0,1]);
		})

		it('[ callback [ object ] ]', function()
		{
			expect(Array.from('12', function(value, index, object) {return object;})).toEqual(['12','12']);
		})

		it('[ callback [ value, index ] ]', function()
		{
			expect(Array.from('12', function(value, index) {return value + index;})).toEqual(['10','21']);
		})

		it('[ callback [ value, index, object ] ]', function()
		{
			expect(Array.from('12', function(value, index, object) {return value + index + object;})).toEqual(['1012','2112']);
		})

		it('[callback, context ] #1', function()
		{
			var object = {0: 10, 1: 20};

			expect(Array.from('01', function(value) {return this[value];}, object)).toEqual([10,20]);
		})

		it('[callback, context ] #2', function()
		{
			var object = {0: 10, 1: 20};

			expect(Array.from([0, 1], function(value) {return this[value];}, object)).toEqual([10,20]);
		})

		it('empty string value', function()
		{
			expect(Array.from('')).toExactlyMatch([]);
		})

		it('Boolean', function()
		{
			expect(Array.from(true)).toExactlyMatch([]);
		})
		...
		{
			expect(Array.from({0: 5, 1: 6, length: 2})).toEqual([5,6]);
		})
    });
});
